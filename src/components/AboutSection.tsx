...
export default function AboutSection() {
  ...
  // Si hay 1 logo se centra; si hay más, distribuye el espacio a lo ancho
  ...
  return (
    <section className="w-full bg-[#070402] text-[#E6E1D7] px-8 md:px-16 pt-6 md:pt-10 pb-20 md:pb-28">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Separador sutil */}
        {hasClients && (
          <div className="w-full h-[1px] bg-[#E1DACB]/10 mb-16" />
        )}

        {/* Subsección: SOME OF OUR CLIENTS */}
        {hasClients && (
          <div>
            <span className="font-metropolis text-xs tracking-[0.2em] text-[#E1DACB]/60 uppercase block mb-10 font-bold">
              SOME OF OUR CLIENTS
            </span>

            {/* Layout Flexbox distributivo horizontal */}
